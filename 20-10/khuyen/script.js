document.addEventListener('DOMContentLoaded', () => {
    ...
    const config = {
        // Nhạc nền
        musicUrl: "mp3/nhac.mp3",

        // Lời nhắn trong popup
        modalMessage: {
            line1: "Hôm nay là 20/10, một ngày đặc biệt dành cho những người con gái đặc biệt.",
            line2: "bạn khuyên là một trong số đó, dịu dàng, tốt bụng và luôn giúp đỡ những người xung quanh.",
        },

        // Các lời chúc chạy nối tiếp
        sequentialMessages: [
            "Chúc bạn khuyên một ngày mới thật tươi đẹp!",
            "Cười lên nhé! Hôm nay là một ngày tuyệt vời!",
            "Gửi đến bạn khuyên một câu chúc thật ấm áp",
            "bạn khuyên là người bạn tốt và đáng mến",
            "Chúc bạn khuyên luôn may mắn và thành công",
            "Cảm ơn bạn khuyên đã luôn là chính mình ❤️"
        ],
        
        // Ảnh cho màn hình trái tim 3D (dùng nhiều ảnh cho đa dạng)
        heartSceneImages: [
            'img/k1.jpg', 'img/k2.jpg',
            'img/k3.jpg', 'img/k4.jpg',
            'img/k5.jpg', 'img/k6.jpg',
            'img/k7.jpg', 'img/k8.jpg',
            'img/k9.jpg', 'img/k10.jpg',
            'img/k11.jpg',
